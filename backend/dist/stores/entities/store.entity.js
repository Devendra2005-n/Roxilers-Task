...
__decorate([
    (0, typeorm_1.Column)({ name: 'owner_id', type: 'uuid', nullable: true, unique: true }),
    __metadata("design:type", String)
], Store.prototype, "ownerId", void 0);
__decorate([
    (0, typeorm_1.OneToOne)(() => user_entity_1.User, (user) => user.ownedStore, { nullable: true, onDelete: 'SET NULL' }),
